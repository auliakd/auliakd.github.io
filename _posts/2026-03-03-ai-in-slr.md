...
<div style="float:right; width:45%; margin: 0 0 1.5rem 1.5rem;">
  <img src="{{ '/assets/img/ai-slr-framework.png' | relative_url }}" style="width:100%; border-radius:8px;">
</div>
...
<div style="float:right; width:45%; margin: 0 0 1.5rem 1.5rem;">
  <img src="{{ '/assets/img/keyword-frequency-clean(2).png' | relative_url }}" style="width:100%; border-radius:8px;">
</div>
...
<div style="float:right; width:45%; margin: 0 0 1.5rem 1.5rem;">
  <img src="{{ '/assets/img/ai-screening-impact(2).png' | relative_url }}" style="width:100%; border-radius:8px;">
</div>
